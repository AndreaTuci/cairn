 ...
 *   - include the awkward rows: the very long title, the missing image, the empty
 *     list. A design that only works on tidy data has not been tested.
 *   - mark optional fields optional. `image?: string` tells a developer the empty
 *     case is real, and forces the design to answer for it.
 */
...
export const articles: Article[] = [
  ...
  {
    id: 'a2',
    title: 'A title that runs on considerably longer than anyone designing the row expected it to, because real editors write like this',
