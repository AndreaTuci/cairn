...
| 18 | The page prints `npx @lotrek/cairn install`, which does not exist | Kept, with a closing section that says so plainly and shows the real `cp -r` commands beside it. **Superseded 2026-08-28**: see row 23 | 2026-08-28 |
...
| 23 | `npx @lotrek/cairn install` still does not exist | The guide now speaks as though it does, and the "what is true today" section is gone. Publishing the package is therefore a release blocker rather than a footnote — `HANDOFF.md`, open question 6 | 2026-08-28 |
